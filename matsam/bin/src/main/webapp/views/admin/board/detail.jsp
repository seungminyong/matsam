...
<form method="post" action="/adm/board/modify">
    <input type="hidden" name="boardSerialNo" value="${boardVO.boardSerialNo}"/>
    <div class="wrapper">
        <table class="table">
            ...
            <tr>
                <th scope="row">제목</th>
                <td colspan="3">
                    <input typ="text" name="boardTitle" id="resname" value="${boardVO.boardTitle}">
                </td>
            </tr>
            <tr>
                <th scope="row">분류</th>
                <td>
                 <span class="box">
                     <select name="label" class="sel">
                         <option value="B01">사용자 공지사항</option>
                         <option value="B04">사장 공지사항</option>
                         <option value="B03">매거진</option>
                     </select>
				 </span>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                    <textarea id="editor" name="boardContent">

...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="<c:url value="/views/test/style.css"/>"/>
</head>
<body>
<!--    <div class="wrapper1"> -->
<div class="calendar">

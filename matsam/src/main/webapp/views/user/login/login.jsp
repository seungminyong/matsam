...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function passwordSearch(){
		window.open('passwordSearch','비밀번호','width=600, height=600, toolbar=no, menubar=no, scrollbars=no, resizable=yes')
		} 
